    ...
    <div id="page">
        ...
        <div class="wrapper">
            ...
            <section  class="column width6 first">
                <form id="sampleform" method="post" action="sendmess"  enctype="multipart/form-data">
	                <p>
	                    <label class="required" for="messtitle">标题：</label><br/>
	                    <input type="text" id="messtitle" class="half title" value="" name="messtitle"/>
	                </p>
	                
	                <s:if test='#session.loginUser.role=="teacher"'>
		                <p>
	                        <label class="required" for="mystus">收件人：</label><br/>
	                        <select id="mystus" class="half" name="mystus">
	                ...
	                </s:if> <s:elseif test='#session.loginUser.role=="student"'>
	                   <p>收件人：我的导师</p>
	                </s:elseif>
	                
	                <p>
	                    <label class="required" for="messcontent">内容：</label><br/>
	                    <textarea id="area3" class="large full" name="messcontent"></textarea>
	                </p>
	                
	                <p>
	                    <label for="attach">上传附件：</label>
                        <input type="file" name="attach" id="attach" class="half"/>
	                </p>
