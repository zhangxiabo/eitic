        ...
        <div class="wrapper">
            ...
            <div  class="column width6 first">
                    ...
                    <table class="display stylized" id="example">
                        ...
                        <tbody>
                        <s:iterator value="notices" id="n">
                            <tr>
                                <td class="center"><s:property value="noticeid" /></td>
                                <td><a href="viewnotice?id=<s:property value="noticeid" />"><s:property value="ntitle" /></a></td>
