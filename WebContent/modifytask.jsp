            ...
            <section class="column width6 first"> 
                <div class="colgroup leading">
                   ...
                   <div class="column width3">
                       <fieldset>
                            <legend>修改课题信息</legend>
                            <form id="sampleform" method="post" action="updatetask?taskid=${task.taskid }">
	                            <p>
	                                <label class="required" for="tasktitle">题目：</label><br/>
	                                <input type="text" id="tasktitle" class="full title" value="" name="tasktitle"/>
	                            </p>
	                            <p>
	                                <label class="required" for="summary">简介：</label><br/>
	                                <textarea id="area2" class="medium full" name="summary"></textarea>
	                            </p>
	                            <p>
